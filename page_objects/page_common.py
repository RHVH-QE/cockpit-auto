...
class CommonPages(SeleniumTest):
    ...
    def check_file_system_list(self):
        ...
        self.assert_text_in_element("//*[@id='mounts']/div[2]/table/tbody/tr[8]/td[2]", "/boot")
        ...
        # tmp 
        self.click("//*[@id='mounts']/div[2]/table/tbody/tr[3]/td[2]")
        self.assert_text_in_element("//*[@id='detail-content']/article/div[2]/table/tbody/tr[1]/td[2]/span", "1 GiB xfs file system")
        self.click("//*[@id='storage-detail']/main/div/section/nav/ol/li[1]/a")
        # var
        self.click("//*[@id='mounts']/div[2]/table/tbody/tr[4]/td[2]")
        self.assert_text_in_element("//*[@id='detail-content']/article/div[2]/table/tbody/tr[1]/td[2]/span", "15 GiB xfs file system")
        self.click("//*[@id='storage-detail']/main/div/section/nav/ol/li[1]/a")
        # var_crash
        self.click("//*[@id='mounts']/div[2]/table/tbody/tr[5]/td[2]")
        self.assert_text_in_element("//*[@id='detail-content']/article/div[2]/table/tbody/tr[1]/td[2]/span", "10 GiB xfs file system")
        self.click("//*[@id='storage-detail']/main/div/section/nav/ol/li[1]/a")
        # var_log
        self.click("//*[@id='mounts']/div[2]/table/tbody/tr[6]/td[2]")
        self.assert_text_in_element("//*[@id='detail-content']/article/div[2]/table/tbody/tr[1]/td[2]/span", "8 GiB xfs file system")
        self.click("//*[@id='storage-detail']/main/div/section/nav/ol/li[1]/a")
        # var_log_audit
        self.click("//*[@id='mounts']/div[2]/table/tbody/tr[7]/td[2]")
        self.assert_text_in_element("//*[@id='detail-content']/article/div[2]/table/tbody/tr[1]/td[2]/span", "2 GiB xfs file system")
        self.click("//*[@id='storage-detail']/main/div/section/nav/ol/li[1]/a")
