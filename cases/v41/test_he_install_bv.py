...
dict1 = OrderedDict(zip(const.he_install_bv, const.he_install_bv_id))
...
def check_he_install_bv(ctx):
    ...
    log.info("Setup hosted engine through ova with bond+vlan as network...")
